...
export default function Thankyou() {
  ...
  const navigation = [
    { title: "Portfolio", path: "https://sabrealam.github.io/Portfolio/" },
    { title: "Github", path: "https://github.com/sabrealam" },
    { title: "LinkedIn", path: "https://www.linkedin.com/in/sabrealam/" },
    { title: "Email", path: "https://mail.google.com/mail/u/2/#inbox?compose=new" },
  ];
    ...
    <div className="flex items-center justify-between py-5 md:block">
      <a href="javascript:void(0)">
        {/* <img
          ...
          alt="Float UI logo"
        /> */}
        <h3 style={{color: "white"}} className="text-2xl font-bold">SABRE ALAM</h3>
      </a>
          ...
          <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
            ...
            >
              <ul className="flex-1 justify-end items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                ...
                <li>
                  <a
                    href="../assets/resume/Sabre Alam Cv.pdf"
                    download
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
          <div className="space-y-5 max-w-4xl mx-auto text-center">
            <h2 className="text-4xl text-white font-extrabold mx-auto md:text-5xl">
              Your Email Id Verified Successfully Thank You For Choosing Us ...
            </h2>
            <p className="max-w-2xl mx-auto text-gray-400">
              A self-motivated, hardworking, Node Js Backend Developer with a
              specialization in Java Script, Python, SQL, REST APIs, MongoDB,
              Git, Github, HTML, CSS, Object-oriented, Proficient in creating
              servers and databases, designing, developing responsive websites.
              Ready to develop his skills and contribute to the growth of the
              organization.
            </p>
            <form
            ...
            >
              ...
              />
              <a
                href="../assets/Sabre Alam.pdf"
                download
                target="_blank"
                onClick={()=>{
                    window.open("../assets/Sabre Alam.pdf");
                }}
